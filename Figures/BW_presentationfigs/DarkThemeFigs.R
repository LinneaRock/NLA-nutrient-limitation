...
ggplot(lim_changes_fullset |>
  ...
  geom_point(aes(Category,DiffEst.P, fill = Category), color = "black", pch = 21, size = 1, 
...
ggsave("Figures/BW_presentationfigs/lim_shifts_ecoreg.png", height = 4, width = 6.5, units = "in", dpi = 1200) 
