...
correlations_data <- nla_data_subset |>
  # filter(year == "2012") |> # same as total except TN better predictor in coastal plains
...
#ggsave("testfolder/1217/F1_linregs.png", height = 4.5, width = 6.4, units = "in", dpi = 1200) 
ggsave("testfolder/1217/F1_linregs_pub.png", height = 4.5, width = 6.4, units = "in", dpi = 1200) 

# NOTE: I also ran these for just 2012 and just 2017 data. 
...
#ggsave("testfolder/1217/F2_Map.png", height = 4.5, width = 6.5, units = "in", dpi = 1200) 
ggsave("testfolder/1217/F2_Map_pub.png", height = 4.5, width = 6.5, units = "in", dpi = 1200) 
...
# ggsave("testfolder/1217/F1_Map_linregs.png", height = 8.5, width = 8, units = "in", dpi = 500) 
...
TP rather than DIN vs TP becaue of better correlation between the total nutrients.") +
  theme(plot.caption.position = "plot",
        plot.caption = element_text(hjust = 0, family = "serif"))
ggsave("testfolder/1217/Forig3_limitedlakes.png", height = 4.5, width = 6.5, units = "in", dpi = 1200) 
...
#ggsave("testfolder/1217/F3_limitbars_ecoreg.png", height = 4.5, width = 6.5, units = "in", dpi = 1200)
ggsave("testfolder/1217/F3_limitbars_ecoreg_pub.png", height = 4.5, width = 6.5, units = "in", dpi = 1200)



#### 4. Limitations change analysis ####
## find only sites that are sampled in both 2012 and 2017
...
ecoreg_plot <- ggplot(lim_changes_fullset |>
  ...
  # ecoregions from 2012-2017. The change is represented as a percent difference in the population (point) with 
...
nat_plot/ecoreg_plot +
  plot_layout(guides = "collect",
              design = layout) +
  plot_annotation(tag_levels = 'a', tag_suffix = ')') 
#ggsave("testfolder/1217/F4_limchanges.png", height = 8.5, width = 6.5, units = "in", dpi = 1200) 
ggsave("testfolder/1217/F4_limchanges_pub.png", height = 6, width = 6.5, units = "in", dpi = 1200) 
...
#ggsave("testfolder/1217/F5_TSbars_ecoreg.png", height = 4.5, width = 6.5, units = "in", dpi = 1200)
ggsave("testfolder/1217/F5_TSbars_ecoreg_pub.png", height = 4.5, width = 6.5, units = "in", dpi = 1200)
...
ggplot(TS_changes_fullset) +
  ...
  labs(x = "",
       y = "% change 2012-2017")+                                                 
  #        caption = "Figure 6. Percent change in trophic state across lakes nationally from 2012-2017, panels separated to show all lakes 
  ...
  theme(axis.text.x = element_text(angle = 49, vjust = 1, hjust =1),
        ...
        plot.caption = element_text(hjust = 0, family = "serif"),
        legend.title = element_blank())
#ggsave("testfolder/1217/F6_TSchanges.png", height = 4.5, width = 6.5, units = "in", dpi = 1200) 
ggsave("testfolder/1217/F6_TSchanges_pub.png", height = 4.5, width = 6.5, units = "in", dpi = 1200) 
...
ggplot(TS_changes_fullseteco) +
  ...
  theme(axis.text.x = element_text(angle = 49, vjust = 1, hjust =1),
        ...
        legend.title = element_blank())
#ggsave("testfolder/1217/F6_TSchanges.png", height = 4.5, width = 6.5, units = "in", dpi = 1200) 
ggsave("testfolder/1217/FX_TSchangesECO.png", height = 4.5, width = 6.5, units = "in", dpi = 1200) 
...
ggsave("testfolder/1217/F7_trophicstates_bylim.png", height = 4.5, width = 6.5, units = "in", dpi = 1200) 
